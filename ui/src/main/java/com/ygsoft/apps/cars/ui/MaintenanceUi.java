package com.ygsoft.apps.cars.ui;
...
import com.ygsoft.apps.cars.AppData;
import com.ygsoft.apps.cars.hc.*;
...
public class MaintenanceUi {
    ...
    private final AppData dataSingleton = AppData.getInstance();
